  ...
  - title: Cardano Wallets
    ...
    grid_items:
      - title: Adalite
        subtitle: ''
        title_align: left
        content: "**AdaLite**\_formerly known as CardanoLite is a lightweight web\_wallet\_for storing your Cardano safely and securely.\_AdaLite\_is developed by Vaccumlabs developers, who are fans and holders of Cardano understood the need of the hour to create a more user-friendly\_wallet\_for Cardano users.\n"
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
